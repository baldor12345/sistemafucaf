        ...
        <div class="card-box table-responsive">
            ...
            <div class="row m-b-30">
                <div class="col-sm-12">
					...
					{!! Form::button('<i class="glyphicon glyphicon-plus"></i> Nuevo', array('class' => 'btn btn-info waves-effect waves-light m-l-10 btn-sm', 'id' => 'btnNuevo', 'onclick' => 'modal (\''.URL::route($ruta["create"], array('listar'=>'SI')).'\', \''.'Nuevo'.'\', this);')) !!}
					{!! Form::close() !!}
                </div>
            </div>
