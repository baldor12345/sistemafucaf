        ...
        <div class="card-box table-responsive">
            ...
            <div class="row m-b-5">
                <div class="col-sm-12">
					...
					{!! Form::button('<i class="glyphicon glyphicon-folder-open "></i> Reportes Mes', array('class' => 'btn btn-success waves-effect waves-light m-l-10 btn-md', 'id' => 'btnNuevoReporte', 'onclick' => 'modal (\''.URL::route($ruta["cargarreporte"], array('listar'=>'SI')).'\', \''.$titulo_reporte.'\', this);')) !!}
					{!! Form::close() !!}
