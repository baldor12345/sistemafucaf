        ...
        <div class="card-box table-responsive">
            ...
            <div class="row m-b-30">
                <div class="col-sm-12">
					...
					{!! Form::button('<i class="glyphicon glyphicon-asterisk"></i> Control Asistencia', array('class' => 'btn btn-success waves-effect waves-light m-l-10 btn-md', 'id' => 'btnControl', 'onclick' => 'modal (\''.URL::route($ruta["cargarcontrolpersona"], array('listar'=>'SI')).'\', \''.$titulo_control.'\', this);')) !!}
					{!! Form::close() !!}
                </div>
            </div>
