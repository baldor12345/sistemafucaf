...
<body>
	<div class="contenedor">
		...
		<table width="100%" class="">
            ...
            <tr>
                <td style="font-size: 8px" colspan="1" class="line_v_id line_h_b2">{{ date('d/m/Y',strtotime( $cuota->fecha_programada_pago)) }}</td>
                <td style="font-size: 8px" colspan="1" class="line_v_id line_h_b2">{{ date('d/m/Y',strtotime( $cuota->fecha_programada_pago)) }}</td>
            ...
            <tr>
                <td style="font-size: 8px" colspan="1" class="line_v_id line_h_b2">{{ $cuota->fecha_programada_pago}}</td>
                <td style="font-size: 8px" colspan="1" class="line_v_id line_h_b2">{{ $cuota->fecha_programada_pago}}</td>
