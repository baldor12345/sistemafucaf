...
<div class="col-lg-12 col-md-12 col-sm-12 text-right">
    {!! Form::button('<i class="fa fa-check fa-lg"></i> Imprimir', array('class' => 'btn btn-success btn-sm', 'id' => 'btnReporteCred', 'onclick' => 'modalrecibopdf(\''.URL::route($ruta['reportecreditos'], array($fecha_inicio, $fecha_inicio)).'\',\''.'100'.'\',\''."Modal".'\' )')) !!}
    &nbsp;
