        ...
        <div class="card-box table-responsive">
            ...
            <div class="row m-b-5">
                <div class="col-sm-12">
					...
					{!! Form::button('<i class="glyphicon glyphicon-plus"></i> Devolucion Capital', array('class' => 'btn btn-info waves-effect waves-light m-l-10 btn-sm', 'id' => 'btnDevolucionCapital', 'onclick' => 'modal (\''.URL::route($ruta["create"], array('listar'=>'SI')).'\', \''.$titulo_registrar.'\', this);')) !!}
