...
<body>
	...
	<table width="100%" class="tabla3">
            ...
            <tr>
				...
				<td width="16%" align="center" style="font-size: 8px"><span class="text">Com. Rec.</span></td>
				@else
				<td width="16%" align="center" style="font-size: 9px"><span class="text">-</span></td>
				@endif
            ...
            <tr>
				...
				<td width="16%" align="center"><span class="text" style="font-size: 8px">{{ $value->transaccion_descrpcion }}</span></td>
				<td width="10%" align="center" style="font-size: 9px">
					<span class="text">
			...
			<tr>
				<td  cellspacing="2" width="34%" align="center" style="font-size: 9px" class="fondo"><strong>TOTAL DE INGRESOS DEL MES</strong></td>
				...
				<td  cellspacing="2" width="16%" align="center" style="font-size: 9px" class="fondo"><strong>-</strong></td>
