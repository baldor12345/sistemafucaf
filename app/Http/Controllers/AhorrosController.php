...
/************************************ RETIRAR AHORROS *************************************** */
    ...
    public function retiro(Request $request){
        ...
        if($caja_id != 0){
            ...
            $persona_id = Libreria::getParam($request->input('persona_id'));
            $descripcion = Libreria::getParam($request->input('descripcionAH'));
            
            $error = DB::transaction(function() use($ahorro_id,$monto_retiro, $persona_id,$request, $caja_id, $descripcion ){
                ...
                $transaccion1->descripcion =$descripcion.". Monto Retiro S/. ".$monto_retiro."";
