...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/reciboaccionventapdf/{id_comprador?}/{id_vendedor?}/{cant?}/{fecha?}', 'AccionesController@reciboaccionventapdf')->name('acciones.reciboaccionventapdf');
     ...
     Route::get('/reportecreditos', 'CreditoController@reportecreditos')->name('creditos.reportecreditos');
     Route::get('creditos/vistareporte', 'CreditoController@vistareporte')->name('creditos.vistareporte');
    ...
    Route::get('recibocuotas/vistasimulador', 'RecibocuotasController@vistasimulador')->name('recibocuotas.vistasimulador');
    Route::post('recibocuotas/listsimulador', 'RecibocuotasController@listsimulador')->name('recibocuotas.listsimulador');
    ...
    Route::get('/distutilcreadoPDF/{anio?}', 'DistUtilidadesController@distutilcreadoPDF')->name('distribucion_utilidades.distutilcreadoPDF');
